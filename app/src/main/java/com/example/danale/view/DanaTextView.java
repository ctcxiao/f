package com.example.danale.view;
...
public class DanaTextView extends AppCompatTextView {
    ...
    public DanaTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public DanaTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DanaTextView(Context context) {
        this(context, null, 0);
    }
